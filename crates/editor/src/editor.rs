...
#[path = "editor/code_actions.rs"]
mod code_actions_impl;
#[path = "editor/completions.rs"]
mod completions_impl;
#[path = "editor/configuration.rs"]
mod configuration_impl;
#[path = "editor/diagnostics.rs"]
mod diagnostics_impl;
#[path = "editor/diff_review.rs"]
mod diff_review_impl;
#[path = "editor/folding.rs"]
mod folding_impl;
#[path = "editor/git_diff.rs"]
mod git_diff_impl;
#[path = "editor/git_integration.rs"]
mod git_integration_impl;
...
impl Editor {
    ...
    pub fn rewrap_impl(&mut self, options: RewrapOptions, cx: &mut Context<Self>) {
            ...
            wrap_ranges
        {
            ...
            let wrapped_text = {
                let mut wrapped_text = reflow::wrap_with_prefix(
                    line_prefix,
